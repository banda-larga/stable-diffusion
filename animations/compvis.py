"""
from Katherine Crowson's k-diffusers implementation
"""
...
class VDenoiser(nn.Module):
    ...
    def loss(self, input, noise, sigma, **kwargs):
        c_skip, c_out, c_in = [
            utils_sampling.append_dims(x, input.ndim) for x in self.get_scalings(sigma)
        ]
        noised_input = input + noise * utils_sampling.append_dims(sigma, input.ndim)
